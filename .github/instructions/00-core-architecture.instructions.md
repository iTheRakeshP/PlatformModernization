...
The modernization workspace has two main areas: **source** (COBOL/JCL input for reverse engineering) and **python** (modernized output).

```
PlatformModernization/
│
├── source/                           # ═══ COBOL/JCL INPUT ═══
│   └── jobs/
│       └── [JOB_NAME]/               # One folder per batch job
│           ├── jcl/                  # JCL files
│           │   └── [JOB].jcl         # Main job JCL
│           ├── programs/             # COBOL programs
│           │   ├── [PROGRAM1].cbl
│           │   ├── [PROGRAM2].cbl
│           │   └── ...
│           ├── copybooks/            # COBOL copybooks
│           │   ├── [INPUT].cpy       # Input record layouts
│           │   ├── [OUTPUT].cpy      # Output record layouts
│           │   └── [COMMON].cpy      # Shared structures
│           ├── sql/                  # DB2 definitions
│           │   ├── ddl.sql           # Table DDL
│           │   └── dclgen/           # DCLGEN output
│           ├── procs/                # JCL PROCs (optional)
│           └── samples/              # Sample data (optional)
│               └── sample_input.dat
│
├── docs/                             # ═══ DOCUMENTATION OUTPUT ═══
│   └── [JOB_NAME]/                   # Generated by @COBOL-Reverse-Engineering-Expert
│       ├── README.md                 # Executive summary
│       ├── job-analysis.md           # JCL analysis
│       ├── data-flow.md              # Data flow diagrams
│       ├── business-rules.md         # Extracted business rules
│       ├── programs/                 # Per-program documentation
│       │   └── [PROGRAM].md
│       ├── copybooks/                # Copybook field layouts
│       │   └── [COPYBOOK].md
│       ├── improvements.md           # Optimization suggestions
│       └── modernization-spec.md     # Spec for Python implementation
│
└── python/                           # ═══ PYTHON OUTPUT ═══
    └── [job_name]/                   # Modernized Python project
        ├── config/
        │   ├── base_config.yaml
        │   ├── dev_config.yaml
        │   ├── test_config.yaml
...
### Workflow
1. **Add COBOL**: Place source in `source/jobs/[JOB_NAME]/`
2. **Analyze**: Use `@COBOL-Reverse-Engineering-Expert` to document
3. **Modernize**: Use `@Python-Batch-Modernization-Architect` to generate `python/[job_name]/`
